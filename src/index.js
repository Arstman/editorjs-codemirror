...
class CodeMirror {
  ...
  constructor ({
    ...
    this.textPlaceholder = config.textPlaceholder || CodeMirror.DEFAULT_CODE_PLACEHOLDER
    this.languagePlaceholder = config.languagePlaceholder || CodeMirror.DEFAULT_LANGUAGE_PLACEHOLDER
